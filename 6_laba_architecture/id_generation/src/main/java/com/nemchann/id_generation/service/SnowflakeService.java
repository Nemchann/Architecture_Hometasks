...
/**
 * 1‑й бит всегда 0,
 * 41 бит для текущего времени в милисек,
 * 10 бит - Worker ID - ID Машины:
 *  5 бит на номер дата-центра (от 0 до 31),
 *  5 бит на номер сервера;
 * 12 бит - порядковый номер sequence
 */
@Service
